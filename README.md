...
3. Download the file if one is listed.
...
## 🧩 Connect it to Unreal Engine

After the app is running, connect it to your Unreal project.

1. Open Unreal Engine.
2. Open the project you want to use.
3. Start the UECortex server or tool from the app.
4. Add the connection details in your AI tool or Unreal workflow, if needed.
5. Test the link by asking the tool to run a small task.
...
4. Ask for a task.
5. Review the result in Unreal Engine.
6. Save your work.
...
- Use a folder with a short path, like `C:\UECortex`
